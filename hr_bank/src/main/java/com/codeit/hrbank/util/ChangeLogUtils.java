...
public class ChangeLogUtils {
  ...
  public static ChangeLog createChangeLog(ChangeLogType type, String ipAddress, String memo,
      Employee employee) {
  ...
  public static Map<String, String> extractEmployeeValues(Employee employee) {
    ...
    values.put("status", employee.getStatus().toString());
    values.put("department",
        employee.getDepartment() != null ? employee.getDepartment().getName() : null);
    values.put("binaryContent",
        employee.getBinaryContent() != null ? employee.getBinaryContent().getName() : null);
    values.put("hireDate",
  ...
  // 변경된 값만 History 생성
  public static List<History> createHistoriesForUpdate(ChangeLog changeLog, Employee oldEmployee,
